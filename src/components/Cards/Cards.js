            ...
            <CardActionArea>
              ...
              <CardContent>
                ...
                <Typography variant="body2" color="textSecondary" component="p">
                  In Beta, site in progress React.js|Node.js|Rest
                  API's|React-Hooks
                </Typography>
              </CardContent>
            </CardActionArea>
          ...
          <Card className={classes.root}>
            <CardActionArea>
              ...
              <CardContent>
                ...
                <Typography variant="body2" color="textSecondary" component="p">
                  A matching game HTML|CSS|JavaScript
                </Typography>
              </CardContent>
            </CardActionArea>
            <CardActions>
          ...
          <Card className={classes.root}>
            <CardActionArea>
              ...
              <CardContent>
                ...
                <Typography variant="body2" color="textSecondary" component="p">
                  Insert an image URL and the API will recognize faces in the
                  image React.js|Rest API's|Node.js|SQL
                </Typography>
              </CardContent>
            </CardActionArea>
            <CardActions>
