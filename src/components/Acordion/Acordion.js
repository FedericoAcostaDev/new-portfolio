    ...
    >
      ...
      >
        ...
        <AccordionDetails>
            ...
            <Typography variant="body2">
              ...
              HTML / CSS / JS / React.js /GraphQL/ webpack / sass -
              Git
            </Typography>
            <Typography variant="body2">
      ...
      >
        <AccordionSummary
          ...
          id="panel2bh-header"
        >
          <Typography className={classes.heading} variant="subtitle2" >e-commerce sites</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography variant='body2'>
      ...
      >
        ...
        >
          ...
          <Typography className={classes.heading} variant="subtitle2" >Back & Data </Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography variant='body2'>
        Back-End: Node.js/ Daemon/ Express.js/ PostMan/ PostgreSQL/ Commerce.js
        </Typography>
        
        </AccordionDetails>
      </Accordion>
      </Grid>
      <Button className={classes.button} href="https://docs.google.com/document/d/e/2PACX-1vSnqiI9ocDHFipLmoIsn5zF3iQ2RAAh5diBUrFkq3bJBC7BYFXgNAhwmcxUK-fTGw/pub" color="inherit">
  View My Resume
</Button >
      </Grid>
      </div>
